...
def test_transform_returns_list_of_dicts_when_given_list_of_one_record():
    # Arrange
    input = [
        {
            "id": "football/2025/sep/tugal-pay-jota-tributes",
            "type": "article",
            "sectionId": "football",
            "sectionName": "Football",
            "webPublicationDate": "2025-09-06T21:22:38Z",
            "webTitle": "World Cup qualifyta tributes",
            "webUrl": "https://www.theguardia-portugal-pay-jota-tributes",
            "apiUrl": "https://content.guard-pay-jota-tributes",
            "fields": {"body": "test"},
            "isHosted": "false",
            "pillarName": "Sport",
        }
...
def test_transform_returns_list_of_dicts_when_passed_list_with_many_records():
    ...
    input = [
        ...
        {
            "id": "football/2025/oct/13/world-cup-quali-defeat",
            "type": "article",
            "sectionId": "football",
            "sectionName": "Football",
            ...
            "fields": {"body": "<p>Sweden hopes of reaching the 2026 </p>"},
            "isHosted": "false",
            "pillarId": "pillar/sport",
            "pillarName": "Sport",
        },
...
def test_transform_returns_four_key_value_pairs_when_passed_valid_input_data():
    # Arrange
    input = [
        {
            "id": "football/2025/sep/tugal-pay-jota-tributes",
            ...
            "sectionName": "Football",
            "webPublicationDate": "2025-09-06T21:22:38Z",
            "webTitle": "World Cup qualifying rugal pay Jota tributes",
            "webUrl": "https://www.e-as-portugal-pay-jota-tributes",
            "apiUrl": "https:ball/202-jota-tributes",
            "fields": {"body": "test"},
            "isHosted": "false",
            "pillarId": "pillar/sport",
            "pillarName": "Sport",
...
def test_transform_returns_1000_or_less_characters_for_content_preview_field():
    # Arrange
    input = [
        {
            "id": "football/2025/sep/06/world-cup-al-pay-jota-tributes",
            "type": "article",
            "sectionId": "football",
            "sectionName": "Football",
            "webPublicationDate": "2025-09-06T21:22:38Z",
            "webTitle": "World Cup qualifying roundup: Ronaota tributes",
            "webUrl": "https://www.theguaributes",
            "apiUrl": "https://contees",
            "fields": {"body": "test"},
            "isHosted": "false",
            "pillarName": "Sport",
        }
